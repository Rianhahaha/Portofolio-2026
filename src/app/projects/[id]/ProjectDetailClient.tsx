    ...
    return (
        <section className="w-full min-h-screen overflow-hidden pb-10 ">
            ...
            <div className='w-full h-[100dvh] relative'>
                <div className="absolute bottom-5 w-full max-w-7xl h-1/2 content-center left-1/2 -translate-x-1/2 z-10 grid grid-cols-1 md:grid-cols-2 px-5">
            ...
            <div className="max-w-7xl mx-auto px-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 py-20">
                    ...
                    <h2 className="text-[5rem] font-bold relative text-right">
                        <ClipboardList className="absolute size-60 opacity-5 right-0 top-1/2 -translate-y-1/2" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 py-20">
                    <h2 className="text-[5rem] font-bold relative">
                        <Cog className="absolute size-60 opacity-5 left-0 top-1/2 -translate-y-1/2" />
                ...
                <div className="py-10">
                    ...
                    >
                      {preview.map((data, i) => (
                        <SwiperSlide key={i}>
                            <Image height={500} width={500} src={data} alt={`Preview ${i}`} className="aspect-video size-full object-center object-cover rounded-2xl border border-white/10" />
                        </SwiperSlide>
                         ))}
