...
export default function ArtworksHomeMain() {
    ...
    return (
        <section className="relative w-full h-[100svh]   font-artwork select-none overflow-hidden ">
            ...
            <motion.div className="absolute top-3 right-2  md:top-[10svh] md:right-[2svw] md:px-10 flex flex-col items-center md:items-start gap-[2svw] w-fit  text-center md:text-left z-50 rotate-0 md:rotate-6"
                initial={{ opacity: 0, scale: 0.95, x: "15svh", skewX: "20deg" }}
                animate={{ opacity: 1, scale: 1, x: 0, skewX: 0 }}
                viewport={{ once: false, margin: "-50px" }}
...
">
            ...
            <motion.div className="absolute size-full -rotate-1 pointer-events-none  bg-black py-[3svh] px-[1.5svw] overflow-hidden"
                initial={{ opacity: 0, y: "-50svh" }}
                animate={{ opacity: 1, y: 0 }}
                viewport={{ once: false, margin: "-50px" }}
                transition={{
                    ...baseTransition, delay: 1.2
                }}
            ...
            <div className="flex size-full z-10 relative">
                ...
                <div className=" h-full flex flex-col justify-center items-center max-w-[100svw] md:max-w-[60svw] max-h-[35svh]  md:max-h-[50svh] m-auto mt-[3svh] md:mt-[15svh]">
                    ...
                    <div className="relative h-full w-full  flex flex-col ">
                        ...
                        <motion.img
                            initial={{ opacity: 0, scale: 0.95, y: "5svh", rotate: "20deg" }}
                            animate={{ opacity: 1, scale: 1, y: 0, rotate: 0 }}
                            viewport={{ once: false, margin: "-50px" }}
                            transition={{ duration: 0.5, ...baseTransition, delay: 0.5 }}
                        ...
                        />
                        <motion.div className="absolute bottom-[-5svw] left-1/2 -translate-x-1/2 -rotate-3 text-white text-[20svw] md:text-[10svw] drop-shadow-[1svh_1svw_0px_rgba(0,0,0,1)]  leading-[0.85] z-[50] pointer-events-none select-none text-shadow-thin "
                            initial={{ opacity: 0, scale: 0.95, y: "5svh", rotate: "20deg" }}
                            animate={{ opacity: 1, scale: 1, y: 0, rotate: 0 }}
                            viewport={{ once: false, margin: "-50px" }}
            ...
            {/* Buttons */}
            <motion.div className="absolute bottom-auto top-[60%] left-1/2 -translate-1/2 md:translate-0 md:top-auto md:bottom-[5svh] md:left-[3svw] flex flex-col items-center md:items-start gap-[2svw] w-full md:w-fit px-10 text-center md:text-left rotate-0 md:-rotate-6 z-50"
                initial={{ opacity: 0, scale: 0.95, x: "-15svh", skewX: "20deg" }}
                animate={{ opacity: 1, scale: 1, x: 0, skewX: 0 }}
                viewport={{ once: false, margin: "-50px" }}
